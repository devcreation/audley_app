@echo off
REM Run this ONCE inside your Flutter project root after copying the lib/ folder
REM It permanently changes the app name in Android and iOS native config files
